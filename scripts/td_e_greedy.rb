...
require "rl_learning/grid_world/td_e_greedy"
...
mc = TemporalDifferenceEGreedy.new(state_transitions:, rewards:)
mc.perform

Utility.table_plot(mc.state_values.reshape(4, 4), title: "state values")
Utility.plot_episode_returns(mc.score_log, title: "TD(0): Episode Return")
